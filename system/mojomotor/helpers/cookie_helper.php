...
if ( ! function_exists('set_cookie'))
{
	function set_cookie($name = '', $value = '', $expire = '', $domain = '', $path = '/', $prefix = '')
	{
		...
		// Check whether they have given consent for cookies
		if ($expire != '' && config_item('require_cookie_consent') == 'y' && get_cookie('cookies_allowed') != 'y' && $name != 'cookies_allowed')
		{
			return;
		}
...
/* Location: system/mojomotor/helpers/cookie_helper.php */