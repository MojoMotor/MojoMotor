...
/*
		https://web.archive.org/web/20120919080359/http://mojomotor.com/user_guide/license.html
 @link		http://mojomotor.com
 @since		Version 1.0
 @filesource
*/
function CKEDITOR_GETURL(a) {}
function region_alter_callback(a) {
  var b = {};
  b.Cancel = function () {
  ...
  b.OK = function () {
    jQuery(".layout_edit_form_dialog").dialog("close");
    jQuery("#mojo_layout_edit_form")
      .prepend('<input type="hidden" name="region_warning" value="accepted" />')
      .submit();
  };
  jQuery(
    "<div class='layout_edit_form_dialog'><p>" +
      a +
      Mojo.Lang.layout_region_warning +
      "</p></div>",
  ).dialog({
    resizable: false,
...
jQuery(document).ready(function () {
  function a() {
    mojoEditor.add_notice(
      '<a href="' +
        Mojo.URL.site_path +
        '/setup/update">' +
        Mojo.Lang.run_update +
        "</a>",
      "system_notice",
    );
  }
